...
export const SignUP = ({ handlesignupform, handlesubmitform, stateformdata, errorpopup }) => {
    ...
    return (
        <>
            ...
            {errorpopup ? <ErrorPopup error={"Mật khẩu không khớp, vui lòng thử lại"} /> : null}
            <div className="HR-form-content justify-center items-center min-[250px]:w-[90%] 2xl:w-[80%] grid grid-cols-1 min-[900px]:grid-cols-2 mx-auto">
                ...
                {/* <div className="form-content flex flex-col gap-6 sm:justify-center min-[250px]:items-center sm:items-center md:items-start md:justify-normal">
                        ...
                        <div className="my-3 form-heading">
                            <h1 className="text-4xl font-bold text-purple-700">Sign UP HR</h1>
                        </div>
                ...
                <div className="grid w-full grid-cols-1 gap-5 form-button-group">
                    ...
                    <div className="flex justify-between w-full buttons">
                        <Button className="min-[250px]:text-xs min-[250px]:px-2 min-[250px]:py-1 sm:px-4 sm:py-2 sm:text-sm md:text-md  px-4 py-2 bg-purple-700 border-2 border-purple-700 text-white font-bold rounded-lg hover:bg-white hover:text-purple-700 hover:cursor-pointer" onClick={handlesubmitform}>Đăng ký</Button>
                        <div className="flex items-center justify-center gap-2 sing-in">
                            <p className="min-[250px]:text-xs sm:text-sm">Đã có tài khoản?</p>
                            <Link to={"/auth/HR/login"}>
                                <Button className="min-[250px]:text-xs min-[250px]:px-2 min-[250px]:py-1 sm:px-4 sm:py-2 sm:text-sm md:text-md px-4 py-2 bg-purple-700 border-2 border-purple-700 text-white font-bold rounded-lg hover:bg-white hover:text-purple-700 hover:cursor-pointer">Đăng nhập</Button>
                            </Link>
                        </div>
                    </div>
