...
export const DashboardEndPoints = {
  GETDBEMPLOYEE: "/api/v1/dashboard/dashboard-by-employee",
...
export const HRInterviewInsightsEndPoints = {
  ...
  DELETE: (interviewID) =>
    `/api/v1/interview-insights/delete-interview/${interviewID}`,
};
...
export const ReportEndPoints = {
  ...
  EXPORT_FULL_SYSTEM_REPORT_PDF: "/api/v1/report/export/full-system-report-pdf",
};
