...
export const VerifyEmployeeToken = (req, res, next) => {
    ...
    try {
        ...
        if (!decoded) {
            ...
            return res.status(403).json({ success: false, message: "Xác thực nhân viên thất bại", gologin : true }) 
        }
...
export const VerifyhHRToken = (req, res, next) => {
    ...
    try {
        ...
        if (!decoded) {
            ...
            return res.status(403).json({ success: false, message: "Xác thực quản trị viên thất bại", gologin : true })
        }
